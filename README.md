  ...
  <tbody>
	...
	<td colspan="3">Trabaja en equipo para proporcionar liderazgo en forma conjunta.</td>
      ...
      <h3>León Morales, Johan Yonel</h3>
        ...
        <b>AV2</b><p>Proporcioné liderazgo compartiendo responsabilidades y apoyando al equipo en la creación, redacción y despliegue del Backend durante el sprint, asegurando un progreso constante.</p>
        <b>TF1</b><p></p>
      <h3>Mauricio Silva, Ghiou Justinn</h3>
        ...
        <b>AV2</b><p>Impulsé la participación del equipo asumiendo un rol activo al guiar parte del proceso de creación, redacción y despliegue del Backend en el sprint.</p>
        <b>TF1</b><p></p>
      ...
      <h3>Santiago Atanacio, Jairo Mathias</h3>
        ...
        <b>TP1</b><p>Asumí un rol de liderazgo coordinando con el equipo para la creación, redacción y despliegue del Frontend, asegurando el avance correcto de este sprint.</p>
    ...
    <tr>
      ...
      <h3>León Morales, Johan Yonel</h3>
        ...
        <b>TP1</b><p>El equipo demostró un liderazgo conjunto durante la creación, redacción y despliegue del Frontend, permitiéndonos cumplir exitosamente con los objetivos trazados para este sprint.</p>
        <b>AV2</b><p>Consolidamos nuestro liderazgo compartido y proactividad para llevar a cabo la creación, redacción y despliegue del Backend exitosamente en este avance.</p>
        <b>TF1</b><p></p>
      <h3>Mauricio Silva, Ghiou Justinn</h3>
        ...
        <b>TP1</b><p>Durante esta etapa del proyecto, participé en la preparación técnica de la Web App para su despliegue, revisando la configuración del proyecto y la instalación de dependencias. Además, cumplí con las metas del sprint trabajando en equipo en la creación, redacción y despliegue del Frontend.</p>
        <b>AV2</b><p>Establecí y cumplí metas junto al resto de mis compañeros, enfocándonos en aportar colaborativamente a la creación, redacción y despliegue del Backend durante el sprint.</p>
        <b>TF1</b><p></p>
      <h3>Pareja Calloapaza, Marcelo Fausto</h3>
        ...
        <b>TP1</b><p>Contribuí en la entrega de tareas responsablemente, desarrollando el análisis del Big Picture y de las reglas de arquitectura. Asimismo, colaboré en el desarrollo de la Landing Page aportando en su creación, redacción y despliegue para lograr los hitos del sprint.</p>
      ...
      <h3>Santiago Atanacio, Jairo Mathias</h3>
        ...
        <b>TP1</b><p>Fomenté un entorno colaborativo e inclusivo, planificando y cumpliendo con las tareas de creación, redacción y despliegue del Frontend.</p>
        <b>TP1</b><p>Colaboré de forma proactiva en el sprint, organizando las tareas y apoyando a mis compañeros en la creación, redacción y despliegue del Frontend.</p>
        <b>AV2</b><p>Participé en la organización de tareas y colaboré de forma equitativa en la creación, redacción y despliegue del Backend, garantizando el éxito de nuestras metas para el sprint.</p>
		  <br>
      </td>
      <td colspan="3">
